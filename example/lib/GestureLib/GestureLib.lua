GestureLib_Mouse_X = 10;	--Mouse position at X
GestureLib_Mouse_Y = 10;	--Mouse position at Y
...
function GestureLib()
	local self = {};
		...
		self.preMouse_X = 10;	--Starting position at X
		self.preMouse_Y = 10;	--Starting position at Y
